...
<div class="m-subheader ">
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title m-subheader__title--separator">Thêm Danh Mục</h3>
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <select class="form-control m-input" id="categoryGroup" name="parent_id">
							...
							@foreach($parentCategory as $parentCategory)
                                <option value="{{$parentCategory->id}}" @if($parentCategory->id == old('parent_id')) selected @endif>{{$parentCategory->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
