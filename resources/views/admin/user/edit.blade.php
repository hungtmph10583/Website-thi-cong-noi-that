...
<div class="m-subheader ">
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title m-subheader__title--separator">Sửa Thông Tin Tài Khoản</h3>
            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-tools">
                    <ul class="nav nav-tabs m-tabs m-tabs-line   m-tabs-line--left m-tabs-line--primary" role="tablist">
                        ...
                        <li class="nav-item m-tabs__item">
                            <a class="nav-link m-tabs__link" href="{{route('user.changePassword', ['id' => $user->id])}}" aria-selected="false">
                                Đổi Mật Khẩu
                            </a>
                        </li>
                    </ul>
                    ...
                    <form method="POST" action="" enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right">
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input" type="email" name="email" value="{{$user->email}}">
                                    @error('email')
                                        <span class="m-form__help m--font-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-10">
                                    <div class="m-radio-inline">
                                        <label class="m-radio m-radio--solid">
                                            <input type="radio" name="status" value="1"{{ ($user->status == 1 ? 'checked' : '') }}> Hoạt Động
                                            <span></span>
                                        </label>
                                        <label class="m-radio m-radio--solid">
                                            <input type="radio" name="status" value="2" {{ ($user->status == 2 ? 'checked' : '') }}> Ngưng Hoạt Động
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
